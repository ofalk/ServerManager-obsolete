...
package SM::Controller::CatPatchtime;
...
# form_generator.pl --rs_name=CatPatchtime --schema_name= --class_prefix=SM::Controller::CatPatchtime --db_dsn=
{
    package SM::Controller::CatPatchtime::CatPatchtimeForm;
    ...
    has '+item_class' => ( default => 'CatPatchtime' );

    has_field 'name' => ( type => 'Text', size => 45, required => 1, );
    # has_field 'servers' => ( type => '+SM::Controller::CatPatchtime::ServerField', );
...
{
    package SM::Controller::CatPatchtime::ServerField;
    use HTML::FormHandler::Moose;
...
sub base : Chained('/') PathPart('catpatchtime') CaptureArgs(0) {}
