...
# form_generator.pl --rs_name=CatSite --schema_name= --class_prefix=SM::Controller::CatSite --db_dsn=
{
    package SM::Controller::CatSite::CatSiteForm;
    ...
    has '+item_class' => ( default => 'CatSite' );

    has_field 'short_name' => ( type => 'Text', size => 45, );
    has_field 'name' => ( type => 'Text', size => 45, required => 1, );
    # has_field 'storages' => ( type => '+SM::Controller::CatSite::StorageField', );
    # has_field 'servers' => ( type => '+SM::Controller::CatSite::ServerField', );
...
{
    package SM::Controller::CatSite::StorageField;
    use HTML::FormHandler::Moose;
...
{
    package SM::Controller::CatSite::ServerField;
    use HTML::FormHandler::Moose;
    extends 'HTML::FormHandler::Field::Compound';
    use namespace::autoclean;
...
sub base : Chained('/') PathPart('catsite') CaptureArgs(0) {}
