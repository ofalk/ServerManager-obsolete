...
package SM::Controller::CatStatus;
...
# form_generator.pl --rs_name=CatStatus --schema_name= --class_prefix=SM::Controller::CatStatus --db_dsn=
{
    package SM::Controller::CatStatus::CatStatusForm;
    ...
    has '+item_class' => ( default => 'CatStatus' );

    has_field 'name' => ( type => 'Text', size => 45, required => 1, );
    # has_field 'cluster_packages' => ( type => '+SM::Controller::CatStatus::ClusterPackageField', );
    # has_field 'servers' => ( type => '+SM::Controller::CatStatus::ServerField', );
...
{
    package SM::Controller::CatStatus::ServerField;
    use HTML::FormHandler::Moose;
...
{
    package SM::Controller::CatStatus::ClusterPackageField;
    use HTML::FormHandler::Moose;
    extends 'HTML::FormHandler::Field::Compound';
    use namespace::autoclean;
...
sub base : Chained('/') PathPart('catstatus') CaptureArgs(0) {}
