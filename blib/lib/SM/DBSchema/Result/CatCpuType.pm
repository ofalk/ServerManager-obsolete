use utf8;
package SM::DBSchema::Result::CatCpuType;
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:E78SVrXKzxrJ93WeI4LT1A


# You can replace this text with custom code or comments, and it will be preserved on regeneration
use overload '""' => sub {$_[0]->name}, fallback => 1;
__PACKAGE__->utf8_columns(qw/cpu_type_id name/);
