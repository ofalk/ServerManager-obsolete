use utf8;
package SM::DBSchema::Result::CatProductCategory;
...
=head1 TABLE: C<CAT_PRODUCT_CATEGORY>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:JShREYQ1CIebFZXzZ6cs7w


# You can replace this text with custom code or comments, and it will be preserved on regeneration
use overload '""' => sub {$_[0]->name}, fallback => 1;
__PACKAGE__->utf8_columns(qw/product_category_id name description costs/);
