...
# form_generator.pl --rs_name=CatAsp --schema_name= --class_prefix=SM::Controller::CatAsp --db_dsn=
{
    package SM::Controller::CatAsp::CatAspForm;
    ...
    has '+item_class' => ( default => 'CatAsp' );

    has_field 'sla_level' => ( type => 'Text', size => 25, );
    has_field 'psp_element' => ( type => 'Text', size => 45, );
    has_field 'service_manager' => ( type => 'Text', size => 45, );
    has_field 'name' => ( type => 'TextArea', );
    # has_field 'cluster_packages' => ( type => '+SM::Controller::CatAsp::ClusterPackageField', );
    # has_field 'servers' => ( type => '+SM::Controller::CatAsp::ServerField', );
...
{
    package SM::Controller::CatAsp::ClusterPackageField;
    use HTML::FormHandler::Moose;
...
{
    package SM::Controller::CatAsp::ServerField;
    use HTML::FormHandler::Moose;
    extends 'HTML::FormHandler::Field::Compound';
    use namespace::autoclean;
...
sub base : Chained('/') PathPart('catasp') CaptureArgs(0) {}
