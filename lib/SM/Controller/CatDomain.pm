...
package SM::Controller::CatDomain;
...
# form_generator.pl --rs_name=CatDomain --schema_name= --class_prefix=SM::Controller::CatDomain --db_dsn=
{
    package SM::Controller::CatDomain::CatDomainForm;
    ...
    has '+item_class' => ( default => 'CatDomain' );

    has_field 'name' => ( type => 'Text', size => 45, required => 1, );
    # has_field 'servers' => ( type => '+SM::Controller::CatDomain::ServerField', );
...
{
    package SM::Controller::CatDomain::ServerField;
    use HTML::FormHandler::Moose;
...
sub base : Chained('/') PathPart('catdomain') CaptureArgs(0) {}
