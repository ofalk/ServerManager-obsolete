...
package SM::Controller::CatLocation;
...
# form_generator.pl --rs_name=CatLocation --schema_name= --class_prefix=SM::Controller::CatLocation --db_dsn=
{
    package SM::Controller::CatLocation::CatLocationForm;
    ...
    has '+item_class' => ( default => 'CatLocation' );

    has_field 'short_name' => ( type => 'Text', size => 45, );
    has_field 'name' => ( type => 'Text', size => 45, required => 1, );
    # has_field 'storages' => ( type => '+SM::Controller::CatLocation::StorageField', );
    # has_field 'servers' => ( type => '+SM::Controller::CatLocation::ServerField', );
...
{
    package SM::Controller::CatLocation::StorageField;
    use HTML::FormHandler::Moose;
...
{
    package SM::Controller::CatLocation::ServerField;
    use HTML::FormHandler::Moose;
    extends 'HTML::FormHandler::Field::Compound';
    use namespace::autoclean;
...
sub base : Chained('/') PathPart('catlocation') CaptureArgs(0) {}
