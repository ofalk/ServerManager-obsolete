...
package SM::Controller::CatOsArchitecture;
...
# form_generator.pl --rs_name=CatOsArchitecture --schema_name= --class_prefix=SM::Controller::CatOsArchitecture --db_dsn=
{
    package SM::Controller::CatOsArchitecture::CatOsArchitectureForm;
    ...
    has '+item_class' => ( default => 'CatOsArchitecture' );

    has_field 'name' => ( type => 'Text', size => 45, required => 1, );
    # has_field 'servers' => ( type => '+SM::Controller::CatOsArchitecture::ServerField', );
...
{
    package SM::Controller::CatOsArchitecture::ServerField;
    use HTML::FormHandler::Moose;
...
sub base : Chained('/') PathPart('catosarchitecture') CaptureArgs(0) {}
