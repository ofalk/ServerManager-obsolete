...
package SM::Controller::CatOsVersion;
...
# form_generator.pl --rs_name=CatOsVersion --schema_name= --class_prefix=SM::Controller::CatOsVersion --db_dsn=
{
    package SM::Controller::CatOsVersion::CatOsVersionForm;
    ...
    has '+item_class' => ( default => 'CatOsVersion' );

    has_field 'name' => ( type => 'Text', size => 45, required => 1, );
    # has_field 'servers' => ( type => '+SM::Controller::CatOsVersion::ServerField', );
...
{
    package SM::Controller::CatOsVersion::ServerField;
    use HTML::FormHandler::Moose;
...
sub base : Chained('/') PathPart('catosversion') CaptureArgs(0) {}
