...
package SM::Controller::CatProductCategory;
...
# form_generator.pl --rs_name=CatProductCategory --schema_name= --class_prefix=SM::Controller::CatProductCategory --db_dsn=
{
    package SM::Controller::CatProductCategory::CatProductCategoryForm;
    ...
    has '+item_class' => ( default => 'CatProductCategory' );

    has_field 'costs' => ( type => 'TextArea', required => 1, );
    has_field 'description' => ( type => 'Text', size => 45, );
    has_field 'name' => ( type => 'Text', size => 45, required => 1, );
    # has_field 'luns' => ( type => '+SM::Controller::CatProductCategory::LunField', );
    # has_field 'servers' => ( type => '+SM::Controller::CatProductCategory::ServerField', );
...
{
    package SM::Controller::CatProductCategory::ServerField;
    use HTML::FormHandler::Moose;
...
{
    package SM::Controller::CatProductCategory::LunField;
    use HTML::FormHandler::Moose;
    extends 'HTML::FormHandler::Field::Compound';
    use namespace::autoclean;
...
sub base : Chained('/') PathPart('catproductcategory') CaptureArgs(0) {}
