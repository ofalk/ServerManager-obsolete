...
package SM::Controller::CatSupportLevel;
...
# form_generator.pl --rs_name=CatSupportLevel --schema_name= --class_prefix=SM::Controller::CatSupportLevel --db_dsn=
{
    package SM::Controller::CatSupportLevel::CatSupportLevelForm;
    ...
    has '+item_class' => ( default => 'CatSupportLevel' );

    has_field 'description' => ( type => 'Text', size => 45, required => 1, );
    has_field 'level_nr' => ( type => 'Text', size => 45, required => 1, );
    # has_field 'servers' => ( type => '+SM::Controller::CatSupportLevel::ServerField', );
...
{
    package SM::Controller::CatSupportLevel::ServerField;
    use HTML::FormHandler::Moose;
...
sub base : Chained('/') PathPart('catsupportlevel') CaptureArgs(0) {}
