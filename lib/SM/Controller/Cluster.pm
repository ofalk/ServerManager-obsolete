...
# form_generator.pl --rs_name=Cluster --schema_name= --class_prefix=SM::Controller::Cluster --db_dsn=
{
    package SM::Controller::Cluster::ClusterForm;
    ...
    has '+item_class' => ( default => 'Cluster' );
    ...
    # has_field 'cluster_packages' => ( type => '+SM::Controller::Cluster::ClusterPackageField', );
    has_field 'cat_cluster_software' => ( type => 'Select', );
    # has_field 'servers' => ( type => '+SM::Controller::Cluster::ServerField', );
...
{
    package SM::Controller::Cluster::ServerField;
    use HTML::FormHandler::Moose;
...
{
    package SM::Controller::Cluster::ClusterPackageField;
    use HTML::FormHandler::Moose;
    extends 'HTML::FormHandler::Field::Compound';
    use namespace::autoclean;
...
sub base : Chained('/') PathPart('cluster') CaptureArgs(0) {}
