...
package SM::Controller::OperatorGroup;
...
# form_generator.pl --rs_name=OperatorGroup --schema_name= --class_prefix=SM::Controller::OperatorGroup --db_dsn=
{
    package SM::Controller::OperatorGroup::OperatorGroupForm;
    ...
    has '+item_class' => ( default => 'OperatorGroup' );

    has_field 'description' => ( type => 'Text', size => 45, );
    has_field 'name' => ( type => 'Text', size => 45, required => 1, );
    # has_field 'servers' => ( type => '+SM::Controller::OperatorGroup::ServerField', );
...
{
    package SM::Controller::OperatorGroup::ServerField;
    use HTML::FormHandler::Moose;
...
sub base : Chained('/') PathPart('operatorgroup') CaptureArgs(0) {}
